...
export default function AnalyticsDashboard() {
  ...
  // Mock data
  const enrollmentData = [120, 145, 132, 178, 165, 210, 198, 245, 230, 278, 265, 310, 298, 340, 325, 380, 365, 420, 408, 455, 443, 490, 478, 520, 510, 545, 530, 580, 565, 612];
  const revenueData = [2400, 2800, 2650, 3200, 3050, 3800, 3600, 4200, 4050, 4800, 4650, 5200, 5050, 5800, 5650, 6200, 6050, 6800, 6650, 7200, 7050, 7800, 7650, 8200, 8050, 8800, 8650, 9200, 9050, 9800];
  const weeklyLabels = ['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'];
  const enrollmentByDay = [48, 62, 54, 73, 69, 42, 35];
  const completionByDay = [12, 18, 15, 22, 19, 11, 8];
  const revByMonth = [18400, 22500, 19800, 28900, 32100, 27600, 35200, 38900, 41200, 45600, 48900, 52300];
        ...
        <>
            ...
            <div className="space-y-6 animate-fade-in">
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                {[
                  ...
                  { label: 'Avg. Rating', value: '4.7/5', icon: 'â­', color: '#f59e0b' },
                ].map((metric) => (
          ...
          {activeSection === 'learning' && (
            <div className="space-y-6 animate-fade-in">
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                {[
                  { label: 'Avg. Time/Session', value: '47 min', icon: 'â±ï¸', color: '#c12129' },
            ...
            <div className="space-y-6 animate-fade-in">
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                {[
                  ...
                  { label: 'Refund Rate', value: '2.1%', change: -0.3, icon: 'â†©ï¸', color: '#8b5cf6' },
                ].map((m) => (
                  <MetricCard
                    key={m.label}
                    label={m.label}
          ...
          {activeSection === 'funnel' && (
            <div className="space-y-6 animate-fade-in">
              ...
              <div className="grid grid-cols-3 gap-4">
                {[
                  { label: 'Visitor â†’ Enroll', value: '36%', desc: 'Of visitors enroll in at least one course', icon: 'ðŸšª', color: '#c12129' },
                  { label: 'Enroll â†’ Pay', value: '35%', desc: 'Of course page views convert to paid enrollment', icon: 'ðŸ’³', color: '#f59e0b' },
                  { label: 'Enroll â†’ Complete', value: '60%', desc: 'Of enrolled students complete the course', icon: 'ðŸŽ“', color: '#10b981' },
                ].map((m) => (
              ...
              <div className="bg-white border border-brand-gray rounded-xl p-5 hover:border-brand-black transition-colors duration-200">
                ...
                <div className="space-y-3">
                  {[
                    { stage: 'Module 1 â†’ Module 2', dropoff: 18, users: 1180 },
