...
export const metadata: Metadata = { title: 'Terms of Service · HybridShare' };
...
const sections = [
  ...
  },
  {
    ...
    body: `These Terms are governed by and construed in accordance with the laws of the jurisdiction in which HybridShare is incorporated, without regard to its conflict of law provisions. Any disputes shall be subject to the exclusive jurisdiction of the courts in that jurisdiction.`,
  },
  {
    title: '12. Contact',
    body: `For questions about these Terms, please contact us at legal@hybridshare.io or write to: HybridShare Legal, 123 Learning Lane, Tech City, TC 10001.`,
  },
];
      ...
      <main className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="mt-12 pt-8 border-t border-brand-gray flex flex-col sm:flex-row gap-4 items-center justify-between">
          <p className="text-xs text-brand-gray-dark">
            Questions? Email <a href="mailto:legal@hybridshare.io" className="text-brand-red hover:underline">legal@hybridshare.io</a>
          </p>
