...
export interface LearningAnalytics {
  ...
  topCourses: Array<{ courseId: string; title: string; enrollments: number; completionRate: number }>;
  progressOverTime: Array<{ date: string; enrollments: number; completions: number }>;
